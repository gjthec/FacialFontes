...
import { TesteService } from "../shared/teste.service"; 
...
@Component({
  selector: 'app-details-teste',
  templateUrl: './teste-form.component.html',
  styleUrls: ['./teste-form.component.scss']
})
export class TesteFormComponent extends BaseResourceFormComponent<Teste> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.testeJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected testeService: TesteService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Teste(), testeService, Teste.fromJson);//Linha alterável com base na classe 
