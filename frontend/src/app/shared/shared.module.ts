...
} from './components/time-field/time-field.component';
...
import { PictureLocationComponent } from './components/picture-location/picture-location.component';
...
@NgModule({
  ...
  providers: [
    ...
    },
    {
      ...
      useValue: { scope: 'components', alias: 'componentsBase' },
    },
  ],
  exports: [
    CommonModule,
